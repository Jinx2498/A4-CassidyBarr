...
namespace GameBrains.Entities.EntityData
{
    ...
    public class SteeringData : KinematicData
    {
        ...
        public new static SteeringData CreateInstance(Transform t)
        {
            SteeringData steeringData = CreateInstance<SteeringData>();
            Initialize(t, steeringData);
            return steeringData;
        }

        protected static void Initialize(Transform t, SteeringData steeringData)
        {
            KinematicData.Initialize(t, steeringData);
        ...
        public new void Reset()
        {
            ...
            {
                foreach (SteeringBehaviour steeringBehaviour in SteeringBehaviours.Values)
                {
                    Destroy(steeringBehaviour);
                }
