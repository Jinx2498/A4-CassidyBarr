...
namespace GameBrains.Entities.EntityData
{
	...
	public class KinematicData : StaticData
	{
		...
		public new static KinematicData CreateInstance(Transform t)
		{
			KinematicData kinematicData = CreateInstance<KinematicData>();
			Initialize(t, kinematicData);
			return kinematicData;
		}

		protected static void Initialize(Transform t, KinematicData kinematicData)
		{
			StaticData.Initialize(t, kinematicData);
			...
			Color? blockedColor = null)
		{
			...
			// BUG: When cast radius multiplier is greater than 1,
			// BUG: and agent touching obstacle, erroneously not blocked.
