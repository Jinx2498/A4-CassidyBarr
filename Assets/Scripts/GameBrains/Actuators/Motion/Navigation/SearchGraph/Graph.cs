...
namespace GameBrains.Actuators.Motion.Navigation.SearchGraph
{
	public class Graph : ExtendedMonoBehaviour
	{
		...
		[UnityEditor.CustomEditor(typeof(Graph))] [UnityEditor.CanEditMultipleObjects]
		public class GraphEditor : UnityEditor.Editor
		{
			Graph graph;
			UnityEditor.SerializedProperty nodeCollectionObjectProperty;
			UnityEditor.SerializedProperty edgeCollectionObjectProperty;
			UnityEditor.SerializedProperty nodeCollectionProperty;
			UnityEditor.SerializedProperty edgeCollectionProperty;
			...
			public override void OnInspectorGUI()
			{
				...
				Object[] filtered
					= UnityEditor.Selection.GetFiltered(typeof(Graph), UnityEditor.SelectionMode.TopLevel);
